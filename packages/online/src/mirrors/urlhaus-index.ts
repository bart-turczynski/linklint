/**
 * URLhaus exact-URL lookup index (LINK-ifpdilfn, M4b).
 *
 ...
 * Both the indexed records and the query URL pass through the shared
 * {@link canonicalizeUrl}. The index is built once from a caller-owned snapshot
 * and queried locally; the enricher performs no network I/O at check time.
 */
